...
export interface AgentIdentityRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, AgentIdentityRegistry.MetadataEntryStruct[]]
  ): string;
  encodeFunctionData(
...
export namespace RegisteredEvent {
  ...
  export type OutputTuple = [agentId: bigint, tokenURI: string, owner: string];
  export interface OutputObject {
    agentId: bigint;
    tokenURI: string;
    owner: string;
...
export interface AgentIdentityRegistry extends BaseContract {
  ...
  "register(string,(string,bytes)[])": TypedContractMethod<
    [agentURI: string, metadata: AgentIdentityRegistry.MetadataEntryStruct[]],
    [bigint],
    "nonpayable"
  >;

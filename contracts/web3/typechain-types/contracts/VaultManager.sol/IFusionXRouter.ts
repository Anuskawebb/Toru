...
export interface IFusionXRouterInterface extends Interface {
  getFunction(
...
export interface IFusionXRouter extends BaseContract {
  connect(runner?: ContractRunner | null): IFusionXRouter;
  waitForDeployment(): Promise<this>;

  interface: IFusionXRouterInterface;

...
CREATE INDEX IF NOT EXISTS "token_metrics_last_seen_idx"            ON "token_metrics" USING btree ("last_seen");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "token_metrics_unique_traders_idx"       ON "token_metrics" USING btree ("unique_traders");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "token_metrics_quality_holder_count_idx" ON "token_metrics" USING btree ("quality_holder_count");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "token_metrics_trade_count_idx"          ON "token_metrics" USING btree ("trade_count");
